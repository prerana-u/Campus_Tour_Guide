    ...
    protected void processImage() {
        ...
        runInBackground(
                () -> {
                    ...
                    Classifier.Recognition bestResult = null;
                    if(!results.isEmpty()) {
                        ...
                        Log.d("bestResult", bestResult.getTitle() + bestResult.getConfidence());
                        if(bestResult.getConfidence() >= .70f) {
                            ...
                            if (location != null && bestResult.getConfidence() >= minimumConfidence) {
                                ...
                                mappedRecognitions.add(bestResult);
